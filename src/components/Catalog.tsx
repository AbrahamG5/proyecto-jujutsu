...
const createItemsCatalog = () => {
  return CharactersAPI.data.map((element) => (
    <div
      key={element.id}
      className="group flex-auto flex-col w-80 h-96 bg-gray-900/70 rounded-2xl hover:scale-105 hover:transition-all hover:duration-300 hover:shadow-2xl hover:shadow-white/40 text-center p-2"
    >
      <img
      ...
      />
      <hr className="bg-blue-400 h-1 w-full my-1 group-hover:bg-white" />
